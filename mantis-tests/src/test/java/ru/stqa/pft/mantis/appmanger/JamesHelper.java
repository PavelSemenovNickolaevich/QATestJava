...
public class JamesHelper {
    ...
    private void initTelnetSession () {
        mailserver = applicationManager.getProperty("mailserver.host");
        int port = Integer.parseInt(applicationManager.getProperty("mailserver.port"));
        String login = applicationManager.getProperty("mailserver.adminlogin");
        String password = applicationManager.getProperty("mailserver.adminpassword");
        try {
